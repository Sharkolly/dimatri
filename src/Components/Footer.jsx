...
const Footer = () => {
  return (
    <div className='w-9/12 mx-auto mt-20 mb-16 flex justify-between max-lg:w-10/12 max-lg:mt-12 max-lg:justify-center max-sm:w-[85%] max-sm:flex-col max-sm:mt-10'>
      <div className='max-lg:hidden'>
        <h1 className='text-2xl font-bold max-lg:hidden'>DIMATRI</h1>
      </div>
      <div className='flex justify-between gap-16 text-center flex-wrap max-lg:gap-12 max-sm:text-left mt-5 max-sm:gap-8'>
